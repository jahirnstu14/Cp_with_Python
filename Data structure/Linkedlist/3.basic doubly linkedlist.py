...
# add first node and pring in doubly linked list
...
# my_doubly_linked_list.printvalue()


# append the node to doubly linkedlist 
...
# print("\nafter the pop the items : ")

# my_doubly_linked_list.pop().value
# my_doubly_linked_list.printvalue()

# prepend the node in the doubly linked list 
# class Node:
#     def __init__(self, value):
#         self.value = value
#         self.next = None
...
# print("\nafter the prepend the items : ")

# my_doubly_linked_list.prepend(3)
# my_doubly_linked_list.printvalue()

# pop the first items from the linkedllist 
# class Node:
#     def __init__(self, value):
#         self.value = value
#         self.next = None
...
# print("\nafter the pop first  the items : ")

# my_doubly_linked_list.pop_first()
# my_doubly_linked_list.printvalue()


# get specific items form the linkedlist  items from the linkedllist 
# class Node:
#     def __init__(self, value):
#         self.value = value
#         self.next = None
...
# set_value () function for update the value of specific node
...
# my_doubly_linked_list.append(3)
# my_doubly_linked_list.printvalue()
# print("after calling set_value method : ")
# my_doubly_linked_list.set_value(1,10)
# my_doubly_linked_list.printvalue()

# insert method to iinsert data in specific location 
...
# remove the items from linkedlist and it'll remove 
